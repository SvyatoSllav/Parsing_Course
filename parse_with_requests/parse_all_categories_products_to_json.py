...
category_page_url = "https://parsinger.ru/html/index4_page_1.html"
schema = "https://parsinger.ru/html/"

category_page_soup = to_bs4_soup(category_page_url)
pagination_div = category_page_soup.find("div", class_="pagen")
pagination_pages = [f"{schema}{tag_a['href']}" for tag_a in pagination_div.find_all("a")]

with open("all_category_products.json", "w", encoding="utf-8") as file:
    result_json = []
